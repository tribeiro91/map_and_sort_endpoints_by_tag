...
The script is responsible for read the OpenAPI file, get the tags, get the endpoints details and, with all this information, sort ascending the endpoints grouped by tag. You can use this script to get information about the OpenAPI file or map the site navigation for your documentation site.
